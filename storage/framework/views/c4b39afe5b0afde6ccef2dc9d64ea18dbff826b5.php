                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tabela de Alunos do Curso de<?php echo e($curso->nome_curso); ?></h6>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $alunos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aluno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($aluno->sobrenome); ?></td>
                                                    <td><?php echo e($aluno->num_processo); ?></td>
                                                    <td><?php echo e($aluno->classe ?? 'Não especificado'); ?></td>
                                                </tr>
...
<?php /**PATH C:\Users\user\OneDrive\Ambiente de Trabalho\site_imel\resources\views/admin/curso.blade.php ENDPATH**/ ?>